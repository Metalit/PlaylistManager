...
DECLARE_JSON_CLASS(PlaylistManager, PlaylistConfig,
    NAMED_VALUE_DEFAULT(bool, Management, true, "enableManagement")
    NAMED_VALUE_DEFAULT(bool, DownloadIcon, false, "showDownloadIcon")
    NAMED_VALUE_DEFAULT(bool, RemoveMissing, true, "removeMissingBeatSaverSongs")
    NAMED_VECTOR(Folder, Folders, "folders")
)
